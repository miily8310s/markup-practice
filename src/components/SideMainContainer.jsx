...
export const SideMainContainer = () => {
  return (
    <main className="columns-post">
      ...
      <div className="post-contents">
        ...
        <div className="post-contents-chat">
          ...
          <div className="post-contents-chat-1st">
            ...
            <div className="post-contents-chat-talk">
              <p>え？子供向け専用の博物館がサンフランシスコにあるんですか？</p>
            </div>
          </div>
          <div className="post-contents-chat-2st">
            <div className="post-contents-chat-face">
            ...
            <div className="post-contents-chat-talk">
              <p>
                いくつかありますよ。私が働いているのは、コンピューターを使ったいろいろなクリエイティブ活動ができる小さな博物館です。地域の子供たちでいつもにぎわっていますよ。
              </p>
            </div>
          </div>
          <div className="post-contents-chat-1st">
            ...
            <div className="post-contents-chat-talk">
              <p>
                それは特に面白そう！とても興味があります。大人も入れるんですか？
              </p>
            </div>
          </div>
          <div className="post-contents-chat-2st">
            ...
            <div className="post-contents-chat-talk">
              <p>
                もちろんです。絵を描いたりアニメーションを作ったりロボットを操作したり楽しい体験がたくさんできますからぜひ訪れてみてくださいね。
              </p>
            </div>
          </div>
        </div>
